...
--
-- Host: localhost    Database: javaconnect
-- ------------------------------------------------------
...
CREATE TABLE `movie` (
  ...
  `movie_long` int DEFAULT NULL,
  `movie_category_Romance` int DEFAULT NULL,
  `movie_category_Comedy` int DEFAULT NULL,
  `movie_category_Drama` int DEFAULT NULL,
  `movie_category_Action` int DEFAULT NULL,
...
CREATE TABLE `user_rating_list` (
  ...
  `user_rating_movie_name` varchar(100) NOT NULL,
  `user_rating_movie_stars` int DEFAULT NULL,
  `user_rating_movie_comments` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`user_account`,`user_rating_movie_name`),
  KEY `user_rating_movie_name` (`user_rating_movie_name`),
  CONSTRAINT `user_rating_list_ibfk_1` FOREIGN KEY (`user_account`) REFERENCES `userdata` (`user_account`),
  CONSTRAINT `user_rating_list_ibfk_2` FOREIGN KEY (`user_rating_movie_name`) REFERENCES `movie` (`movie_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_rating_list`
--

LOCK TABLES `user_rating_list` WRITE;
/*!40000 ALTER TABLE `user_rating_list` DISABLE KEYS */;
INSERT INTO `user_rating_list` VALUES (9,'1234','Batman Returns',4,'Dark and stylish'),(NULL,'1234','Doc Hollywood',4,NULL),(NULL,'1234','Dragon: The Bruce Lee Story',1,NULL),(1,'1234','Memphis Belle',4,'Great movie!'),(17,'1234','Men in Black',4,'Fun and entertaining'),(25,'1234','To Wong Foo Thanks for Everything, Julie Newmar',4,'Empowering story'),(NULL,'2345','But I\'m a Cheerleader',1,NULL),(13,'2345','Teenage Mutant Ninja Turtles III',2,'Weakest installment'),(5,'2345','Terminator 2: Judgment Day',1,'Epic sci-fi'),(21,'2345','The Addams Family',4,'Ghoulishly delightful'),(29,'2345','The Shawshank Redemption',5,'Masterpiece'),(23,'32345t623','Encino Man',2,'Silly but entertaining'),(15,'32345t623','Spy Hard',2,'Disappointing spoof'),(7,'32345t623','Teenage Mutant Ninja Turtles',NULL,'Childhood favorite'),(12,'4321','Dragon: The Bruce Lee Story',4,'Inspiring biography'),(20,'4321','Green Card',3,'Quirky romantic comedy'),(4,'4321','Men at Work',2,'Disappointing'),(28,'4321','The Man Without a Face',3,'Emotional drama'),(24,'432145','Dumb and Dumber',4,'Stupidly funny'),(16,'432145','Starship Troopers',3,'Sci-fi action'),(8,'432145','Teenage Mutant Ninja Turtles II: The Secret of the Ooze',3,'Entertaining sequel'),(22,'432556','Doc Hollywood',3,'Feel-good comedy'),(30,'432556','Forrest Gump',5,'Heartwarming journey'),(6,'432556','Point Break',4,'Thrilling action'),(14,'432556','The Mask',4,'Hilarious comedy'),(2,'clark84322','Another 48 Hrs.',3,'Average movie'),(26,'clark84322','Jumanji',5,'Adventurous fantasy'),(18,'clark84322','Pretty Woman',4,'Charming romance'),(10,'clark84322','Under Siege',3,'Classic action'),(3,'qwe84322','Hard to Kill',4,'Action-packed'),(19,'qwe84322','Home Alone',5,'Holiday classic'),(27,'qwe84322','Jerry Maguire',4,'Inspirational sports drama'),(11,'qwe84322','Jurassic Park',5,'Revolutionary special effects');
/*!40000 ALTER TABLE `user_rating_list` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_watch_list` (
  ...
  `user_watch_movie_name` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`watch_list_id`),
  KEY `user_account` (`user_account`),
  KEY `user_watch_movie_name` (`user_watch_movie_name`),
  CONSTRAINT `user_watch_list_ibfk_1` FOREIGN KEY (`user_account`) REFERENCES `userdata` (`user_account`),
  CONSTRAINT `user_watch_list_ibfk_2` FOREIGN KEY (`user_watch_movie_name`) REFERENCES `movie` (`movie_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_watch_list` VALUES (1,'1234','Memphis Belle'),(2,'clark84322','Another 48 Hrs.'),(3,'qwe84322','Hard to Kill'),(4,'4321','Men at Work'),(5,'2345','Terminator 2: Judgment Day'),(6,'432556','Point Break'),(7,'32345t623','Teenage Mutant Ninja Turtles'),(8,'432145','Teenage Mutant Ninja Turtles II: The Secret of the Ooze'),(9,'1234','Batman Returns'),(10,'clark84322','Under Siege'),(11,'qwe84322','Jurassic Park'),(12,'4321','Dragon: The Bruce Lee Story'),(13,'2345','Teenage Mutant Ninja Turtles III'),(14,'432556','The Mask'),(15,'32345t623','Spy Hard'),(16,'432145','Starship Troopers'),(17,'1234','Men in Black'),(18,'clark84322','Pretty Woman'),(19,'qwe84322','Home Alone'),(20,'4321','Green Card'),(21,'2345','The Addams Family'),(22,'432556','Doc Hollywood'),(23,'32345t623','Encino Man'),(24,'432145','Dumb and Dumber'),(25,'1234','To Wong Foo Thanks for Everything, Julie Newmar'),(26,'clark84322','Jumanji'),(27,'qwe84322','Jerry Maguire'),(28,'4321','The Man Without a Face'),(29,'2345','The Shawshank Redemption'),(30,'432556','Forrest Gump');
...
INSERT INTO `userdata` VALUES ('1234','1234',NULL),('2345','asd8743',NULL),('32345t623','asd8743',NULL),('4321','asd8743',NULL),('432145','asd8743',NULL),('432556','asd8743',NULL),('clark84322','ricky8743',NULL),('qwe84322','asd8743',NULL);
/*!40000 ALTER TABLE `userdata` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'javaconnect'
--
...
-- Dump completed on 2023-07-11 10:40:09
